...
function(plywood, chronoshift) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c83 = function(ref) { return i$(ref.name); },
        ...
        peg$c108 = "true",
        peg$c109 = peg$literalExpectation("TRUE", true),
        peg$c110 = function() { return true; },
        peg$c111 = "false",
        peg$c112 = peg$literalExpectation("FALSE", true),
        peg$c113 = function() { return false; },
        peg$c114 = "select",
        peg$c115 = peg$literalExpectation("SELECT", true),
        peg$c116 = function() { return 'SELECT'; },
        peg$c117 = "describe",
        peg$c118 = peg$literalExpectation("DESCRIBE", true),
        peg$c119 = "explain",
        peg$c120 = peg$literalExpectation("EXPLAIN", true),
        peg$c121 = function() { return 'DESCRIBE'; },
        peg$c122 = "show",
        peg$c123 = peg$literalExpectation("SHOW", true),
        peg$c124 = function() { return 'SHOW'; },
        peg$c125 = "set",
        peg$c126 = peg$literalExpectation("SET", true),
        peg$c127 = function() { return 'SET'; },
        peg$c128 = "use",
        peg$c129 = peg$literalExpectation("USE", true),
        peg$c130 = function() { return 'USE'; },
        peg$c131 = "variables",
        peg$c132 = peg$literalExpectation("VARIABLES", true),
        peg$c133 = "databases",
        peg$c134 = peg$literalExpectation("DATABASES", true),
        peg$c135 = "schemas",
        peg$c136 = peg$literalExpectation("SCHEMAS", true),
        peg$c137 = "columns",
        peg$c138 = peg$literalExpectation("COLUMNS", true),
        peg$c139 = "full",
        peg$c140 = peg$literalExpectation("FULL", true),
        peg$c141 = "tables",
        peg$c142 = peg$literalExpectation("TABLES", true),
        peg$c143 = "global",
        peg$c144 = peg$literalExpectation("GLOBAL", true),
        peg$c145 = "session",
        peg$c146 = peg$literalExpectation("SESSION", true),
        peg$c147 = "from",
        peg$c148 = peg$literalExpectation("FROM", true),
        peg$c149 = "as",
        peg$c150 = peg$literalExpectation("AS", true),
        peg$c151 = "on",
        peg$c152 = peg$literalExpectation("ON", true),
        peg$c153 = "left",
        peg$c154 = peg$literalExpectation("LEFT", true),
        peg$c155 = "inner",
        peg$c156 = peg$literalExpectation("INNER", true),
        peg$c157 = "join",
        peg$c158 = peg$literalExpectation("JOIN", true),
        peg$c159 = "union",
        peg$c160 = peg$literalExpectation("UNION", true),
        peg$c161 = "where",
        peg$c162 = peg$literalExpectation("WHERE", true),
        peg$c163 = "group",
        peg$c164 = peg$literalExpectation("GROUP", true),
        peg$c165 = "by",
        peg$c166 = peg$literalExpectation("BY", true),
        peg$c167 = "order",
        peg$c168 = peg$literalExpectation("ORDER", true),
        peg$c169 = "having",
        peg$c170 = peg$literalExpectation("HAVING", true),
        peg$c171 = "limit",
        peg$c172 = peg$literalExpectation("LIMIT", true),
        peg$c173 = "asc",
        peg$c174 = peg$literalExpectation("ASC", true),
        ...
        peg$c179 = "between",
        peg$c180 = peg$literalExpectation("BETWEEN", true),
        peg$c181 = "in",
        peg$c182 = peg$literalExpectation("IN", true),
        peg$c183 = "is",
        peg$c184 = peg$literalExpectation("IS", true),
        peg$c185 = "like",
        peg$c186 = peg$literalExpectation("LIKE", true),
        peg$c187 = "contains",
        peg$c188 = peg$literalExpectation("CONTAINS", true),
        peg$c189 = "regexp",
        peg$c190 = peg$literalExpectation("REGEXP", true),
        peg$c191 = "escape",
        peg$c192 = peg$literalExpectation("ESCAPE", true),
        peg$c193 = "not",
        peg$c194 = peg$literalExpectation("NOT", true),
        peg$c195 = "and",
        peg$c196 = peg$literalExpectation("AND", true),
        peg$c197 = "or",
        peg$c198 = peg$literalExpectation("OR", true),
        peg$c199 = "distinct",
        peg$c200 = peg$literalExpectation("DISTINCT", true),
        peg$c201 = "count",
        peg$c202 = peg$literalExpectation("COUNT", true),
        peg$c203 = function() { return 'count'; },
        peg$c204 = "count_distinct",
        peg$c205 = peg$literalExpectation("COUNT_DISTINCT", true),
        peg$c206 = function() { return 'countDistinct'; },
        peg$c207 = "sum",
        peg$c208 = peg$literalExpectation("SUM", true),
        peg$c209 = function() { return 'sum'; },
        peg$c210 = "avg",
        peg$c211 = peg$literalExpectation("AVG", true),
        peg$c212 = function() { return 'average'; },
        peg$c213 = "min",
        peg$c214 = peg$literalExpectation("MIN", true),
        peg$c215 = function() { return 'min'; },
        peg$c216 = "max",
        peg$c217 = peg$literalExpectation("MAX", true),
        peg$c218 = function() { return 'max'; },
        peg$c219 = "quantile",
        peg$c220 = peg$literalExpectation("QUANTILE", true),
        peg$c221 = function() { return 'quantile'; },
        peg$c222 = "custom",
        peg$c223 = peg$literalExpectation("CUSTOM", true),
        peg$c224 = function() { return 'customAggregate'; },
        peg$c225 = "custom_aggregate",
        peg$c226 = peg$literalExpectation("CUSTOM_AGGREGATE", true),
        peg$c227 = "date",
        peg$c228 = peg$literalExpectation("DATE", true),
        peg$c229 = function() { return 'd'; },
        peg$c230 = "time",
        peg$c231 = peg$literalExpectation("TIME", true),
        peg$c232 = function() { return 't'; },
        peg$c233 = "timestamp",
        peg$c234 = peg$literalExpectation("TIMESTAMP", true),
        peg$c235 = function() { return 'ts'; },
        peg$c236 = "d",
        peg$c237 = peg$literalExpectation("D", true),
        peg$c238 = "t",
        peg$c239 = peg$literalExpectation("T", true),
        peg$c240 = "ts",
        peg$c241 = peg$literalExpectation("TS", true),
        peg$c242 = "interval",
        peg$c243 = peg$literalExpectation("INTERVAL", true),
        peg$c244 = /^[a-z_]/i,
        peg$c245 = peg$classExpectation([["a", "z"], "_"], false, true),
        peg$c246 = peg$otherExpectation("Number"),
        peg$c247 = function(n) { return parseFloat(n); },
        peg$c248 = /^[1-9]/,
        peg$c249 = peg$classExpectation([["1", "9"]], false, false),
        peg$c250 = ".",
        peg$c251 = peg$literalExpectation(".", false),
        peg$c252 = "e",
        peg$c253 = peg$literalExpectation("e", true),
        peg$c254 = /^[+\-]/,
        peg$c255 = peg$classExpectation(["+", "-"], false, false),
        peg$c256 = /^[0-9]/,
        peg$c257 = peg$classExpectation([["0", "9"]], false, false),
        peg$c258 = peg$otherExpectation("("),
        peg$c259 = "(",
        ...
        peg$c272 = peg$otherExpectation("Name"),
        peg$c273 = /^[a-z0-9_]/i,
        peg$c274 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, true),
        peg$c275 = peg$otherExpectation("RelaxedName"),
        peg$c276 = /^[a-z_\-:*\/]/i,
        peg$c277 = peg$classExpectation([["a", "z"], "_", "-", ":", "*", "/"], false, true),
        peg$c278 = /^[a-z0-9_\-:*\/]/i,
        peg$c279 = peg$classExpectation([["a", "z"], ["0", "9"], "_", "-", ":", "*", "/"], false, true),
        peg$c280 = peg$otherExpectation("NotSQuote"),
        peg$c281 = /^[^']/,
        peg$c282 = peg$classExpectation(["'"], true, false),
        peg$c283 = peg$otherExpectation("NotDQuote"),
        peg$c284 = /^[^"]/,
        peg$c285 = peg$classExpectation(["\""], true, false),
        peg$c286 = peg$otherExpectation("Whitespace"),
        peg$c287 = /^[ \t\r\n]/,
        peg$c288 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false),
        peg$c289 = "/*",
